      ...
      <div class="col-md-3">
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            ...
            <p class="text-muted text-center">Last Visit: </p>

            <ul class="list-group list-group-unbordered mb-3">
              <li class="list-group-item">
                <b>Temperature</b> <a class="float-right">1,322</a>
              </li>
              <li class="list-group-item">
                <b>Heart Rate</b> <a class="float-right">543</a>
              </li>
              <li class="list-group-item">
                <b>Respiratory Rate</b> <a class="float-right">13,287</a>
              </li>
              <li class="list-group-item">
                <b>Blood pressure</b> <a class="float-right">13,287</a>
              </li>
              <li class="list-group-item">
                <b>Sats</b> <a class="float-right">13,287</a>
              </li>
              <li class="list-group-item">
                <b>Weight</b> <a class="float-right">13,287</a>
              </li>
              <li class="list-group-item">
                <b>Height</b> <a class="float-right">13,287</a>
              </li>
            </ul>
